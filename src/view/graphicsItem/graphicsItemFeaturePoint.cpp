...
//---------------------------------------------------------------------------------------
GraphicsItemFeaturePoint::GraphicsItemFeaturePoint(ModelFile* model_data
...
//---------------------------------------------------------------------------------------
void GraphicsItemFeaturePoint::paintACross(uint x
										  ,uint y
...
//---------------------------------------------------------------------------------------
void GraphicsItemFeaturePoint::paint(QPainter* painter
