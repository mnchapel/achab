#ifndef MODEL_FILE_CONFIDENCE_VALUE_H
#define MODEL_FILE_CONFIDENCE_VALUE_H
...
class ModelFileConfidenceValue : public ModelFile
{
	Q_OBJECT;
...
protected:
	...
	QVector<double> confidence_value;
...
public:
    ...
    /// @param parent
	ModelFileConfidenceValue(Project* project
    ...
    /// @brief Destructor.
    virtual ~ModelFileConfidenceValue() noexcept = default;
...
#endif /* MODEL_FILE_CONFIDENCE_VALUE_H */
