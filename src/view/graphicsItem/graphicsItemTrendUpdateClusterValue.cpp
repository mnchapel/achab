...
//---------------------------------------------------------------------------------------
GraphicsItemTrendUpdateClusterValue::GraphicsItemTrendUpdateClusterValue(ModelFile* model_data
...
//---------------------------------------------------------------------------------------
void GraphicsItemTrendUpdateClusterValue::paintACross(uint x
										  	  ,uint y
...
//---------------------------------------------------------------------------------------
void GraphicsItemTrendUpdateClusterValue::paint(QPainter* painter
