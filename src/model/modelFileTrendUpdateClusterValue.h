#ifndef MODEL_FILE_TREND_UPDATE_CLUSTER_VALUE_H
#define MODEL_FILE_TREND_UPDATE_CLUSTER_VALUE_H
...
class ModelFileTrendUpdateClusterValue : public ModelFile
{
	Q_OBJECT;
...
protected:
	...
	QVector<double> trend_update_cluster_value;
...
public:
    ...
    /// @param parent
	ModelFileTrendUpdateClusterValue(Project* project
    ...
    /// @brief Destructor.
    virtual ~ModelFileTrendUpdateClusterValue() noexcept = default;
...
#endif /* MODEL_FILE_TREND_UPDATE_CLUSTER_VALUE_H */
