...
//---------------------------------------------------------------------------------------
ModelFileLabel::ModelFileLabel(Project* project
...
//---------------------------------------------------------------------------------------
void ModelFileLabel::convertData() noexcept
{
	model_phase.clear();
...
//---------------------------------------------------------------------------------------
void ModelFileLabel::convertSelectedData(int index_selected_data) noexcept
{
...
//---------------------------------------------------------------------------------------
void ModelFileLabel::fillInformation() noexcept
{
	...
	QString distance = QString("Confidence value %1").arg(label[index_selected_data]);
...
//---------------------------------------------------------------------------------------
void ModelFileLabel::init(uint current_frame) noexcept
{
...
//---------------------------------------------------------------------------------------
void ModelFileLabel::processDataFile(QFile& file) noexcept
{
	uint l;
...
//---------------------------------------------------------------------------------------
void ModelFileLabel::readDataFile(uint current_frame) noexcept
{
	label.clear();
