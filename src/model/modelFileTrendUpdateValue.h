#ifndef MODEL_FILE_TREND_UPDATE_VALUE_H
#define MODEL_FILE_TREND_UPDATE_VALUE_H
...
class ModelFileTrendUpdateValue : public ModelFile
{
	Q_OBJECT;
...
protected:
	...
	QVector<double> trend_update_value;
...
public:
    ...
    /// @param parent
	ModelFileTrendUpdateValue(Project* project
    ...
    /// @brief Destructor.
    virtual ~ModelFileTrendUpdateValue() noexcept = default;
...
#endif /* MODEL_FILE_TREND_UPDATE_VALUE_H */
